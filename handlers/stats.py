...
async def stats(message: Message):
    ...
    week = await db.get_week_expenses(uid)
    ...
    text = (
        ...
        f"За 7 дней потрачено: <b>{week:,} сум</b>\n"
    ...
    if week >= config.WEEKLY_ALERT_THRESHOLD:
        text += (
            f"\n⚠️ За неделю расходы уже превысили {config.WEEKLY_ALERT_THRESHOLD:,} сум. "
